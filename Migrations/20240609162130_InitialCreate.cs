...
namespace ApiGenitique.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_StudentProgresses_Quizzes_QuizId",
                        column: x => x.QuizId,
            ...
            migrationBuilder.InsertData(
                table: "Courses",
                columns: new[] { "Id", "CategoryId", "CompletionRate", "Title" },
                values: new object[,]
                {
                    { 1, 1, 0.9f, "Course A1" },
                    { 2, 2, 0.85f, "Course E1" },
                    { 3, 3, 0.75f, "Course AP1" },
                    { 4, 4, 0.95f, "Course AS1" },
                    { 5, 5, 0.8f, "Course D1" }
                });

            migrationBuilder.InsertData(
                table: "Quizzes",
                columns: new[] { "Id", "CourseId", "Score", "Title" },
                values: new object[,]
                {
                    { 1, 1, 0.75f, "Quiz 1" },
                    { 2, 1, 0.9f, "Quiz 2" },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentProgresses_QuizId",
                table: "StudentProgresses",
                column: "QuizId");
